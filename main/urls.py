...
from main.views import register, login_user, logout_user, edit_product, delete_product, get_product_json, add_product_ajax, create_product_flutter, delete_all  
